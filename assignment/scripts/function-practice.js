...
// of petals it means they are in love. Write a function that will take 
// the number of petals of each flower and return true if they are in love and false if they aren't.
...
console.log('Case: flower1 = 4 and flower2 = 3:', lovefunc(4,3));
console.log('Case: flower1 = 4 and flower2 = 6:', lovefunc(4,6));
console.log('Case: flower1 = 3 and flower2 = 3:', lovefunc(3,3));
console.log('Case: flower1 = 3 and flower2 = 4:', lovefunc(3,4));
